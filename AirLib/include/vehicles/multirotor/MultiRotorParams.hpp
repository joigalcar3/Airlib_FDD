...
protected: //static utility functions for derived classes to use
    ...
    /// <summary>
    /// It initializes the multirotor parameters of the Bebop 2
    /// </summary>
    /// <param name="rotor_poses">vector of the pose (3D position, normal vector and direction of rotation) of each of the rotos</param>
    /// <param name="rotor_count">the number of rotors</param>
    /// <param name="arm_lengths">the length of the drone arms that hold the rotors</param>
    /// <param name="rotor_z">the height of the rotor cg with respect to the drone cg</param>
    ...
    /// <summary>
    /// Provides the parameters of the Bebop 2 drone
    /// </summary>
    /// <param name="params">Params object that will contain the Bebop 2 parameters after running the function</param>
    void setupFrameBB2Leon(Params& params)
    {
        //set up arm lengths
        ...
        params.inertia(0, 0) = 0.001926040435298 + 0.1150 * 0.1150 * 0.005 * 4; params.inertia(0, 1) = 0;                                                 params.inertia(0, 2) = 1.925867868808132e-05;
        params.inertia(1, 0) = 0;                                                 params.inertia(1, 1) = 0.001854031455574 + 0.0875 * 0.0875 * 0.005 * 4; params.inertia(1, 2) = 0;
        params.inertia(2, 0) = 1.925867868808132e-05;                              params.inertia(2, 1) = 0;                                                 params.inertia(2, 2) = 0.003338820631580 + (0.1150 * 0.1150 + 0.0875 * 0.0875) * 0.005 * 4;
    }
