...
public: //these APIs uses above low level APIs
    ...
    virtual void setCameraActivation(bool activation, int sample_rate, const std::vector<ImageCaptureBase::ImageRequest>& request, VehicleSimApiBase* const &api);
    virtual void cleanCameraStoredData();
    virtual void saveCameraStoredData(std::string path);
    virtual void setImuActivation(bool activation, int sample_rate);
    virtual void cleanImuStoredData();
    virtual IMUStoredData getImuStoredDataVec();
    virtual void setBarometerActivation(bool activation, int sample_rate);
    virtual void cleanBarometerStoredData();
    virtual BarometerStoredData getBarometerStoredDataVec();
    virtual void setMagnetometerActivation(bool activation, int sample_rate);
    virtual void cleanMagnetometerStoredData();
    virtual MagnetometerStoredData getMagnetometerStoredDataVec();
    virtual void setGPSActivation(bool activation, int sample_rate);
