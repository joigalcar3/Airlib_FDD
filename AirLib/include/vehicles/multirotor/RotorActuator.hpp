...
protected:
    virtual void setWrench(Wrench& wrench) override
    {
        ...
        //wrench.force = normal * output_.thrust * air_density_ratio_ * params_.damage_coeff;
        //wrench.torque = normal * output_.torque_scaler * air_density_ratio_ * params_.damage_coeff; //TODO: try using filtered control here
